...
object DauApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sparkConf: SparkConf = new SparkConf().setAppName("dau_app").setMaster("local[2]")
    ...
    val inputGetOffsetDstream: DStream[ConsumerRecord[String, String]] = recordInputStream
      .transform { rdd =>
